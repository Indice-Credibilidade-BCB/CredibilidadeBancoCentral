...
Etapa 0 do projeto: monta o corpus de imprensa que alimenta o índice de
credibilidade. Multi-colaborador, interrompível e retomável.
...
Saídas, sempre em `dados/` na raiz do repositório:

    dados/bruto/            registros crus, um arquivo por veículo por pessoa
    dados/concluidas/       o que cada pessoa já varreu (compartilhado)
...
Só `concluidas/` e `planos/` vão para o Git — o texto das matérias fica na
máquina de quem coleta. Ver a regra de dados no README da raiz.
